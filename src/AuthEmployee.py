...
class AuthEmployee(object):
    ...
    def create_authorization_form(self):
        ...
        self.age_line_edit.setValidator(QIntValidator(18, 100, self.main_window))
        ...
        self.price_line_edit.setValidator(
            QRegularExpressionValidator(QRegularExpression("[1-9]\\d{0,11}"), self.main_window))
    ...
    def create_gender_picker_row(self):
        self.gender_picker = QWidget(self.main_window)
